package com.tmobile.mytmobile.echolocate.networkmanager
...
import com.tmobile.mytmobile.echolocate.network.util.NetworkSharedPreference
import io.reactivex.Observable

class NetworkProvider private constructor(val context: Context) :
    INetworkProvider {
    ...
    override fun setLogLevel(level: Int) {
        NetworkSharedPreference.init(context)
        NetworkSharedPreference.logLevel = level
    }
