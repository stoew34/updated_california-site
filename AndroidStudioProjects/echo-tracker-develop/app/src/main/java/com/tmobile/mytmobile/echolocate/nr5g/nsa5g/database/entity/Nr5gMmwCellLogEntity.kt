...
/**
 * class that declares all variables of Nr5gMmwCellLogEntity
 * These are columns stored in the room data base for Nr5gMmwCellLogEntity
 */
@Entity(
    tableName = Nr5gDatabaseConstants.NR5G_MMW_CELL_LOG_TABLE_NAME, foreignKeys = [ForeignKey(
...
data class Nr5gMmwCellLogEntity(
    /**
