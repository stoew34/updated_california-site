...
/**
 * Class that declare all the variables of base echolocate 5G entity
 * These are columns stored in the room data base for base echolocate 5G entity
 */
@Entity(tableName = Nr5gDatabaseConstants.NR5G_ECHO_LOCATE_BASE_TABLE_NAME)
data class BaseEchoLocateNr5gEntity(

    /**
     * The Echo locate 5G data is captured when there is an event trigger. Each trigger should have
