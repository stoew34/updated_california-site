...
/**
 * class that declares all variables of Nr5gLocationEntity
 * These are columns stored in the room data base for Nr5gLocationEntity
 */
@Entity(
    tableName = Nr5gDatabaseConstants.NR5G_LOCATION_TABLE_NAME, foreignKeys = [ForeignKey(
