...
/**
 * class that declares all variables of Nr5gOEMSVEntity
 * These are columns stored in the room data base for Nr5gOEMSVEntity
 */
@Entity(
    tableName = Nr5gDatabaseConstants.NR5G_OEMSV_TABLE_NAME, foreignKeys = [ForeignKey(
