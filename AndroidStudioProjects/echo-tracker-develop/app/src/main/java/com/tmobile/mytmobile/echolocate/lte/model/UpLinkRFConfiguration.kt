...
/**
 * Represents the information about the device's uplink radio frequency configuration such as number
 * of layers used
 */
data class UpLinkRFConfiguration(
    ...
    constructor() : this(
        listOf(CAData(null,null,null,0,null,"",
            null,null,null)),
