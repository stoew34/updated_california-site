...
/**
 * class that declares all variables of Sa5gActiveNetworkEntity
 * These are columns stored in the room data base for Sa5gActiveNetworkEntity
 */
@Entity(
    tableName = Sa5gDatabaseConstants.SA5G_GET_ACTIVE_NETWORK_TABLE_NAME, foreignKeys = [ForeignKey(
...
data class Sa5gActiveNetworkEntity(
