...
/**
 * class that declares all variables of Nr5gUiLogEntity
 * These are columns stored in the room data base for Nr5gUiLogEntity
 */
@Entity(
    tableName = Nr5gDatabaseConstants.NR5G_UI_LOG_TABLE_NAME, foreignKeys = [ForeignKey(
...
data class Nr5gUiLogEntity(
    ...
    /**
     * Returns the state of the network connection used to determine whether to display the 5G icon or the 4G
     * LTE icon
