...
class Nr5gOEMSVProcessorTest {
    ...
    fun testGetNr5gStatusProcessor() {
        ...
        Nsa5gOEMSVProcessor(context).processNr5gMetricsData(baseNr5gMetricsData, baseNr5gData)
        latch.await(1, TimeUnit.SECONDS)

        val nr5gOEMSVEntity2 = nr5gDao.getNr5gOEMSVEntity(sessionId)
        Assert.assertNotNull(nr5gOEMSVEntity2)
    }
}