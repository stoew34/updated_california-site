...
class Sa5gWiFiStateProcessorTest {
    ...
    @Test
    public fun testSa5gWiFiStateProcessor() {
        ...
        val sa5gWiFiStateProcessor = Sa5gWiFiStateProcessor(context!!)
        ...
        sa5gWiFiStateProcessor.processSa5gMetricsData(baseSa5gMetricsData, baseSa5gData)
        latch.await(1, TimeUnit.SECONDS)

        val sa5gWiFiStateEntity2 = sa5gDao.getSa5gWiFiStateEntity(sessionId)
        latch.await(1, TimeUnit.SECONDS)
        Assert.assertNotNull(sa5gWiFiStateEntity2)
    }
