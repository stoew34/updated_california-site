...
class Sa5gRrcLogProcessorTest {
    ...
    @Test
    public fun testSa5gRrcLogProcessor() {
        ...
        val sa5gRrcLogProcessor = Sa5gRrcLogProcessor(context!!)
        ...
        sa5gRrcLogProcessor.processSa5gMetricsData(baseSa5gMetricsData, baseSa5gData)
        latch.await(1, TimeUnit.SECONDS)

        val sa5gRrcLogEntity2 = sa5gDao.getSa5gRrcLogEntity(sessionId)
        latch.await(1, TimeUnit.SECONDS)
        Assert.assertNotNull(sa5gRrcLogEntity2)
    }
