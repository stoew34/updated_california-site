...
class Nr5gDataNetworkTypeProcessorTest {
    ...
    fun testGetNr5gStatusProcessor() {
        ...
        val nr5gDataNetworkTypeEntity1 = Nr5gDataNetworkTypeEntity(
            "",
            3
        )

        val baseNr5gMetricsData = BaseNr5gMetricsData(
            nr5gDataNetworkTypeEntity1,
            "",
        ...
        Nsa5gDataNetworkTypeProcessor(context).processNr5gMetricsData(baseNr5gMetricsData, baseNr5gData)
        latch.await(1, TimeUnit.SECONDS)

        val nr5gDataNetworkTypeEntity2 = nr5gDao.getNr5gDataNetworkTypeEntity(sessionId)
        Assert.assertNotNull(nr5gDataNetworkTypeEntity2)
    }
}