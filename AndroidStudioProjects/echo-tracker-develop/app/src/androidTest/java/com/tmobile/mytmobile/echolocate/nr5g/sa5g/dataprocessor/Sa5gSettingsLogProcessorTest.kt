...
class Sa5gSettingsLogProcessorTest {
    ...
    @Test
    public fun testSa5gSettingsLogProcessor() {
        ...
        val sa5gSettingsLogProcessor = Sa5gSettingsLogProcessor(context!!)
        ...
        sa5gSettingsLogProcessor.processSa5gMetricsData(baseSa5gMetricsData, baseSa5gData)
        latch.await(1, TimeUnit.SECONDS)

        val sa5gSettingsLogEntity2 = sa5gDao.getSa5gSettingsLogEntity(sessionId)
        latch.await(1, TimeUnit.SECONDS)
        Assert.assertNotNull(sa5gSettingsLogEntity2)
    }
