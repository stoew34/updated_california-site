...
class Sa5gDownlinkCarrierLogsProcessorTest {
    ...
    @Test
    public fun testSa5gDownlinkCarrierLogsProcessor() {
        ...
        val sa5gDownlinkCarrierLogsEntity = Sa5gDownlinkCarrierLogsEntity(
            "sa5g", "2", "arfcn", "bandWidth",
            "isPrimary", "isEndAnchor", "modulationType", "transmissionMode",
            "numberLayers", "cellId", "pci",
            "tac", "lac", "rsrp", "rsrq", "rssi", "rscp", "sinr", "csiRsrp", "csiRsrq",
            "csiRssi", "csiSinr"
        )

        val sa5gDownlinkCarrierLogsEntityList : MutableList<Sa5gDownlinkCarrierLogsEntity> = mutableListOf()
        sa5gDownlinkCarrierLogsEntityList.add(sa5gDownlinkCarrierLogsEntity)

        val sa5gDownlinkCarrierLogsProcessor = Sa5gDownlinkCarrierLogsProcessor(context!!)

        val baseSa5gMetricsData = BaseSa5gMetricsData(
                sa5gDownlinkCarrierLogsEntityList,
            "",
        ...
        sa5gDownlinkCarrierLogsProcessor.processSa5gMetricsData(baseSa5gMetricsData, baseSa5gData)
        latch.await(1, TimeUnit.SECONDS)

        val sa5gDownlinkCarrierLogsEntity2 = sa5gDao.getSa5gDownlinkCarrierLogsEntity(sessionId)
        latch.await(1, TimeUnit.SECONDS)
        Assert.assertNotNull(sa5gDownlinkCarrierLogsEntity2)
    }
    @After
