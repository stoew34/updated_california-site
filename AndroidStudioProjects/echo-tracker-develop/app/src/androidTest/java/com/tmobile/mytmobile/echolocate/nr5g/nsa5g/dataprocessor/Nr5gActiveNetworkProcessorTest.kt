...
class Nr5gActiveNetworkProcessorTest {
    ...
    fun testGetNr5gStatusProcessor() {
        ...
        val nr5gActiveNetworkEntity1 = Nr5gActiveNetworkEntity(
            99
        )

        val baseNr5gMetricsData = BaseNr5gMetricsData(
            nr5gActiveNetworkEntity1,
            "",
        ...
        Nsa5gActiveNetworkProcessor(context).processNr5gMetricsData(baseNr5gMetricsData, baseNr5gData)
        latch.await(1, TimeUnit.SECONDS)

        val nr5gActiveNetworkEntity2 = nr5gDao.getNr5gActiveNetworkEntity(sessionId)
        latch.await(1, TimeUnit.SECONDS)
        Assert.assertNotNull(nr5gActiveNetworkEntity2)
    }
}