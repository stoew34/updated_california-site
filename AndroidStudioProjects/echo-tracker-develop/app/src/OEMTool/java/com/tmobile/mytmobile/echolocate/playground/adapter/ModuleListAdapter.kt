...
class ModuleListAdapter internal constructor(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val gridView: View
        val rowViewHolder: ListRowHolder
        if (convertView == null) {
            ...
            gridView.tag = rowViewHolder
        } else {
            gridView = convertView
            rowViewHolder = gridView.tag as ListRowHolder
        }
        rowViewHolder.label.text = modules[position].key
        ...
        buttonText.setOnClickListener {
            intent = when (position) {
                ...
                ModulesEnum.OEMTOOL.ordinal ->          Intent(mContext, OEMToolHomeActivity::class.java)
                else -> null
            }
